...
class LLMRefiner:
    ...
    PROMPTS = {
        "refine": (
            ...
            "入力された音声認識テキストから、「えー」「あー」「えっと」などの不要なフィラーを取り除き、誤字脱字や不自然な助詞を修正してください。\n"
            "【重要制約】\n"
            "・話し手の元の文体・語尾（タメ口、常体「だ・である」、敬語「です・ます」など）や口調のトーンは絶対にそのまま保持してください。\n"
            "・常体やタメ口の文章を勝手に「です・ます調（丁寧語）」へ変換することは厳禁です。\n"
