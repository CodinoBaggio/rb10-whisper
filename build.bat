...
pyinstaller --onefile --noconfirm --noconsole --paths . --hidden-import=keyring --hidden-import=keyring.backends.Windows --copy-metadata=keyring --name "rb10-whisper" launcher.py
